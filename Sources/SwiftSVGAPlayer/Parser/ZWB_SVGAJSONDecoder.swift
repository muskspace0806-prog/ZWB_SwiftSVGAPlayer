// Sources/SwiftSVGAPlayer/Parser/ZWB_SVGAJSONDecoder.swift
// 解析旧版 SVGA movie.spec JSON 格式
...
final class SVGAJSONDecoder {
    ...
    func decode(specData: Data, imageEntries: [String: Data]) throws -> SVGAVideo {
    ...
    private func mapToVideo(json: [String: Any], imageEntries: [String: Data]) throws -> SVGAVideo {
    ...
    private func mapSprite(_ json: [String: Any], totalFrames: Int) throws -> SVGASprite {
    ...
    private func mapFrame(_ json: [String: Any]) throws -> SVGAFrame {
